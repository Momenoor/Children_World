...
--
-- Host: 127.0.0.1
-- Generation Time: 08 أكتوبر 2022 الساعة 18:38
...
(16, 'lkj', '3686', 'omar', '202cb962ac59075b964b07152d234b70', 'التمهيدي', '2022-10-12', NULL),
...
(5, 'أيوش', '056586546', 'aya', '202cb962ac59075b964b07152d234b70', 'التمهيدي - العباقرة', 'تكنولوجيا', NULL),
...
CREATE TABLE `weekly-plan` (
  ...
  `subject1` varchar(2500) NOT NULL,
  `subject2` varchar(2500) NOT NULL,
  `subject3` varchar(2500) NOT NULL,
  `subject4` varchar(2500) NOT NULL,
  `subject5` varchar(2500) NOT NULL,
  `subject6` varchar(2500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

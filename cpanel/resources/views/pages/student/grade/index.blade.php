                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                @foreach ($grades as $grade)
                                    <tr class="odd">
                                        <td>{{ $grade->name }}</td>
                                        <td>( {{ $grade->students_count }} ) <a href="{{ route('grade.student', $grade) }}">
                                                عرض الطلاب</a></td>
                                        <td>( {{ $grade->teachers_count }} ) <a href="{{ route('grade.teacher', $grade) }}">
                                                عرض المعلمين</a></td>

<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" dir="{{ config('backpack.base.html_direction') }}" direction="{{ config('backpack.base.html_direction') }}" style="direction: {{ config('backpack.base.html_direction') }}">
<!--begin::Head-->
...
<body id="kt_body" class="{{ config('backpack.base.body_class') }}"
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="{{ asset('asset/demo13/dist/index.html') }}" class="d-lg-none">

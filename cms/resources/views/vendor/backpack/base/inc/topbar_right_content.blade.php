        ...
        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
            ...
            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ asset('asset/demo13/dist/pages/search/horizontal.html') }}"
...
<div class="d-flex align-items-center">
    <!--begin::Menu toggle-->
    <a href="#" class="topbar-item px-3 px-lg-5" data-kt-menu-trigger="{default:'click', lg: 'hover'}"
...
<div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
        ...
        <div class="menu-item px-5">
            <a href="{{ asset('asset/demo13/dist/account/overview.html') }}" class="menu-link px-5">My Profile</a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->
        <div class="menu-item px-5">
            <a href="{{ asset('asset/demo13/dist/apps/projects/list.html') }}" class="menu-link px-5">
        ...
        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ asset('asset/demo13/dist/account/referrals.html') }}"
                        class="menu-link px-5">Referrals</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ asset('asset/demo13/dist/account/billing.html') }}"
                        class="menu-link px-5">Billing</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ asset('asset/demo13/dist/account/statements.html') }}"
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-5">
            <a href="{{ asset('asset/demo13/dist/account/statements.html') }}" class="menu-link px-5">My
                Statements</a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu separator-->
        ...
        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ asset('asset/demo13/dist/account/settings.html') }}"
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ asset('asset/demo13/dist/account/settings.html') }}" class="menu-link d-flex px-5">
                        <span class="symbol symbol-20px me-4">
        ...
        <div class="menu-item px-5 my-1">
            <a href="{{ asset('asset/demo13/dist/account/settings.html') }}" class="menu-link px-5">Account
                Settings</a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->

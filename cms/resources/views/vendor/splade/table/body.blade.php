        ...
        >
            ...
            @foreach($table->columns() as $column)
                <td
                    ...
                    class="whitespace-nowrap text-sm @if($loop->first && $hasBulkActions) pl-6 @else px-6 @endif py-4 @if($column->highlight) text-gray-900 font-medium @else text-gray-500 @endif"
                >

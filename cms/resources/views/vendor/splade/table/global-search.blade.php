<div class="relative">
    <input
      class="block w-full sm:pr-9 text-sm rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300"
    ...
    >
    <div class="absolute inset-y-0 right-0 pr-3 hidden sm:flex items-center pointer-events-none">

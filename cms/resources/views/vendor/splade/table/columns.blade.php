        ...
        <ul class="divide-y divide-gray-200">
            @foreach($table->columns() as $column)
                ...
                <li class="py-2 flex items-center justify-between">
                    ...
                    <button
                        type="button"
                        class="mr-4 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500"
                        :class="{

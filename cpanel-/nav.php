...
session_start();
 ...
 if ((isset($_SESSION['teacher'])) ||(isset($_SESSION['teacher-id'])) ||
 (isset($_SESSION['admin-id'])) ||(isset($_SESSION['admin']))||
 (isset($_SESSION['student-id']))||(isset($_SESSION['student']))){}
                          ...
                          <?php  if ((isset($_SESSION['admin'])) ||(isset($_SESSION['admin-id']))) {
                             ...
                             echo '  <b class="caret"></b>
                                ...
                                <ul class="dropdown-menu dropdown-user">
                                    <li><a href="profile-admin.php"><i class="fa fa-user fa-fw"></i> الملف الشخصي</a>
                                    </li>';
                            ...
                            elseif ((isset($_SESSION['teacher'])) ||(isset($_SESSION['teacher-id']))) {
                              ...
                              echo '  <b class="caret"></b>
                                ...
                                <ul class="dropdown-menu dropdown-user">
                                    <li><a href="profile-student.php"><i class="fa fa-user fa-fw"></i> الملف الشخصي</a>
                                    </li>';
                        ...
                        <?php if ((isset($_SESSION['admin-id'])) ||(isset($_SESSION['admin']))) {
                           ...
                           echo  '  <li>                                   
                                ...
                                <!-- /.nav-second-level -->
                                    ...
                                    <?php if ((isset($_SESSION['teacher-id'])) ||(isset($_SESSION['teacher']))||(isset($_SESSION['admin']))||(isset($_SESSION['admin-id'])) ) 
                                    {
                            ...
                            <li>
                            <?php  if ((isset($_SESSION['teacher'])) ||(isset($_SESSION['teacher-id']))) {
                             echo'  <a href="student-teach.php"><i class="fa fa-edit fa-fw"></i> الطلاب</a>';}?>
                            </li>
                            <li>
                                <a href="activities.php"><i class="fa fa-edit fa-fw"></i> نشاطات</a>
                            </li>
                            <li>
                           <?php if ((isset($_SESSION['admin'])) ||(isset($_SESSION['admin-id']))){
                           ...
                           الواجبات</a>';
                            ...
                            <li>
                           <?php if ((isset($_SESSION['student'])) ||(isset($_SESSION['student-id']))){
                           echo '<a href="rate-student.php"><i class="fa fa-fw"  aria-hidden="true" title="Copy to use star">&#xf005</i>
                           التقييمات</a>';
                           }?>
                            </li>

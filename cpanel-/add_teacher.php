...
if (isset($_REQUEST['name'])){
    ...
    $phone= $_REQUEST['phone'];
        ...
        if($result){
            echo
            "<div class='form'>
<h6 class='text-success text-center  alert alert-danger'> تم اضافة معلم جديد بنجاح! 
</h6>
</div>";
...
<form name="add-teacher" action="add_teacher.php" method="post">
<input type="text" name="name" placeholder="الاسم" required /></br></br>
<input type="text" name="specialization" placeholder="التخصص" required /></br></br>
<input type="text" name="user" placeholder="اسم المستخدم" required /></br></br>
<input type="password" name="pass" placeholder="كلمة المرور" required /></br></br>

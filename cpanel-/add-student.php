...
if (isset($_REQUEST['name'])){
    ...
    $query1 = "SELECT * FROM `student` where username='$user_name' ";
...
?>
                    ...
                    <form name="add-student" action="add-student.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>الجوال </label>
                                                    <input type="number" name="phone" class="form-control" placeholder="اكتب هنا .."value="<?php if (isset($_REQUEST['name'])) { echo $phone;}?>" required>
                                                </div>  
                                                 <div class="form-group">
                                                    <label>اسم المستخدم</label>
                                                    <input name="user" class="form-control" placeholder="اكتب هنا .."value="<?php if (isset($_REQUEST['name'])) { echo $user_name;}?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>تاريخ الميلاد </label>
                                                    <input name="date" type="date" class="form-control" placeholder="اكتب هنا .."value="<?php if (isset($_REQUEST['name'])) { echo $date;}?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>كلمة المرور  </label>
                                                    <input name="pass" type="password" class="form-control" placeholder="اكتب هنا .."value="<?php if (isset($_REQUEST['name'])) { echo $pass;}?>" required>
                                                </div>
